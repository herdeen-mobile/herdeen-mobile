...
// src/app/menu-overlay.tsx
import React, { useState } from 'react';
import { View, Text, ScrollView, TouchableOpacity, Image, Switch, Modal, Linking } from 'react-native';
...
export default function MenuOverlayScreen() {
  ...
  // State for the "Rate Us" modal visibility
  const [isRateModalVisible, setIsRateModalVisible] = useState(false);

  // Handler for store redirection from Rate Us modal
  ...
  // Handler for joining the community WhatsApp group
  const handleJoinCommunity = () => {
    Linking.openURL('https://wa.me/2340000000000'); // Replace with actual community link
  };
    ...
    <View className="flex-1 bg-white">
      ...
      <ScrollView className="flex-1 px-6 pt-12 pb-10">
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.9}
          className="bg-[#FAF5FF] border border-[#F3E8FF] rounded-3xl p-5 mb-8 flex-row justify-between items-center relative overflow-hidden shadow-sm"
        >
          <View className="flex-1 pr-3">
            <View className="flex-row items-center gap-1.5 mb-1">
              <Text className="text-base font-bold text-gray-900">Join Her Community</Text>
          ...
          <View className="bg-card rounded-t-[32px] p-6 pb-12 border-t border-border shadow-2xl">
            ...
            <View className="items-center mb-6">
              <View className="w-24 h-24 rounded-full bg-secondary items-center justify-center border border-border">
                <Ionicons name="star" size={36} color="#9333EA" />
              </View>
            </View>
